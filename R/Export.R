...
exportExposures <- function(outputFolder, exportFolder) {
  ...
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "Iodine131Thyroid2ndCancerRisk")
  ...
  createExposureRow <- function(exposureId) {
    ...
    cohortFileName <- system.file("cohorts", paste0(name, ".json"), package = "Iodine131Thyroid2ndCancerRisk")
