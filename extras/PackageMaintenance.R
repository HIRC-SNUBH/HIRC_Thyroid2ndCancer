...
OhdsiRTools::checkUsagePackage("Thyroid2ndCancer")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/Thyroid2ndCancer.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Thyroid2ndCancer.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Thyroid2ndCancer")
